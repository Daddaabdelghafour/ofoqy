                    ...
                    <form className="flex flex-col gap-4 md:gap-6" onSubmit={submit}>
                        <div className="grid gap-4 md:gap-6">
                            ...
                            <div className="w-full" data-aos="fade-up" data-aos-delay="700">
                                ...
                                {/* Divider */}
                                <div className="my-4 flex items-center md:my-6" data-aos="fade-up" data-aos-delay="800">
                                    <div className="flex-1 border-t border-gray-300"></div>
                                    <span className="px-3 text-xs text-gray-500 md:px-4 md:text-sm">ou</span>
                                    <div className="flex-1 border-t border-gray-300"></div>
                                </div>

                                {/* Social Login Buttons - Stack on mobile, side by side on larger screens */}
                                <div className="flex flex-col gap-3 sm:flex-row md:gap-4" data-aos="fade-up" data-aos-delay="900">
                                    {/* Google Login Button */}
                                    <button
                                        type="button"
                                        className="btn btn-secondary flex flex-1 items-center justify-center gap-2 rounded-sm border border-gray-300 bg-white px-3 py-3 text-gray-700 transition-all duration-200 hover:scale-105 hover:border-gray-400 hover:bg-gray-50 active:scale-95 md:px-4 md:py-2.5 lg:px-6 lg:py-3"
                                        onClick={() => {
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-medium md:text-sm lg:text-base">Google</span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-medium md:text-sm lg:text-base">Instagram</span>
                                    </button>
                                </div>
                            </div>
                        </div>
