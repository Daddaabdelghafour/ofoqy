...
function Orientation() {
    return (
        <div data-aos="fade" data-aos-duration="2000" className="section-padding container-custom bg-[#1D7A850A] flex flex-col items-center">
            ...
            <div className='flex flex-col md:flex-row justify-center my-12 gap-6 md:gap-0 w-full items-center'>
                ...
                <div className='p-4 md:p-7 flex flex-col items-center justify-center'>
